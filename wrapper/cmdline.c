/*
  ...
  gengetopt --input=wrapper.ggo --file-name=cmdline 
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->proxy_help = gengetopt_args_info_help[3] ;
  args_info->login_help = gengetopt_args_info_help[4] ;
  args_info->code_from_file_help = gengetopt_args_info_help[5] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->login_given)
    write_into_file(outfile, "login", 0, 0 );
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVH:P:LF", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'L':	/* .  */
          ...
          if (update_arg((void *)&(args_info->login_flag), 0, &(args_info->login_given),
              &(local_args_info.login_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "login", 'L',
              additional_error))
            goto failure;
